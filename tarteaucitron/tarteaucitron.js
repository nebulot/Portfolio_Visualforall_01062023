          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.parameters.showIcon === true) {
                    ...
                    html += '       <img src="' + (tarteaucitron.parameters.iconSrc ? tarteaucitron.parameters.iconSrc : 'assets/tools/biscuit.png') + '" alt="' + tarteaucitron.lang.icon + ' ' + tarteaucitron.lang.modalWindow + '" title="' + tarteaucitron.lang.icon + ' ' + tarteaucitron.lang.modalWindow + '">';
                    html += '   </button>';
                    html += '</div>';
                }
